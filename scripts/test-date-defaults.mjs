...
const dir=path.resolve('.runtime','date-defaults-ui-'+Date.now());fs.mkdirSync(dir,{recursive:true});
...
try{
 ...
 const child=spawn(electron,['scripts/test-date-defaults-runner.cjs',dir,base],{windowsHide:true,stdio:'ignore'});
