...
const dir=path.resolve('.runtime','library-ui-'+Date.now());fs.mkdirSync(dir,{recursive:true});
...
const service=spawn(python,['scripts/library-ui-fixture.py'],{windowsHide:true,stdio:['ignore','ignore','pipe'],env:{...process.env,TIJIAN_DATA:dir,TIJIAN_PORT:String(port)}});
...
try{
 ...
 const child=spawn(electron,['scripts/test-library-runner.cjs',dir,base],{windowsHide:true,stdio:'ignore'});
