...
const dir=path.resolve('.runtime','capabilities-ui-'+Date.now());fs.mkdirSync(dir,{recursive:true});
...
const service=spawn(python,['scripts/capabilities-ui-fixture.py'],{windowsHide:true,stdio:['ignore','ignore','pipe'],env:{...process.env,TIJIAN_DATA:dir,TIJIAN_PORT:String(port)}});
...
try{
 ...
 const child=spawn(electron,['scripts/test-capabilities-runner.cjs',dir,base],{windowsHide:true,stdio:'ignore'});
