...
const dir=path.resolve('.runtime','knowledge-ui-'+Date.now());fs.mkdirSync(dir,{recursive:true});
...
const service=spawn(python,['scripts/knowledge-ui-fixture.py'],{windowsHide:true,stdio:['ignore','ignore','pipe'],env:{...process.env,TIJIAN_DATA:dir,TIJIAN_PORT:String(port)}});
...
try{
 ...
 const child=spawn(electron,['scripts/test-knowledge-runner.cjs',dir,base],{windowsHide:true,stdio:'ignore'});
