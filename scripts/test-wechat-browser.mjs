...
const dir=path.resolve('.runtime','wechat-browser-ui-'+Date.now());fs.mkdirSync(dir,{recursive:true});
...
try{
 ...
 const child=spawn(electron,['scripts/test-wechat-browser-runner.cjs',dir,base],{windowsHide:true,stdio:'ignore'});
