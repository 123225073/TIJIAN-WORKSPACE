...
const dir=path.resolve('.runtime','account-entry-'+Date.now());fs.mkdirSync(dir,{recursive:true});
...
try{
 ...
 const child=spawn(createRequire(import.meta.url)('electron'),['scripts/test-account-entry-runner.cjs',dir,base],{windowsHide:true,stdio:'inherit'});
