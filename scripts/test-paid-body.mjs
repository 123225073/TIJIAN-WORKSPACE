...
const dir=path.resolve('.runtime','paid-body-ui-'+Date.now());fs.mkdirSync(dir,{recursive:true});
...
try{
 ...
 const child=spawn(electron,['scripts/test-paid-body-runner.cjs',dir,base],{windowsHide:true,stdio:'ignore'});
